...
void packageDs(uint16_t data, uint64_t *ds)
{
    *ds = 0ULL;
    ...
    uint8_t digit1 =  (uint8_t)(data         % 10u);
    uint8_t digit2 = (uint8_t)((data / 10u)  % 10u);
    uint8_t digit3 = (uint8_t)((data / 100u) % 10u);
    uint8_t digit4 = (uint8_t)((data / 1000u)% 10u);
